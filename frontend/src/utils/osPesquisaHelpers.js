...
export function prepareOSExportData(data) {
  return data.map(os => ({
    ...
    'Solicitou OS': os.solicitante_os_nome || '',
    'Tipo Solicitante': os.solicitante_os_tipo === 'titular' ? 'Particular' : 'Empresa',
    'Faturamento': os.pagador_os_nome || '',
    'Tipo Pagador': os.pagador_os_tipo === 'titular' ? 'Particular' : 'Empresa',
